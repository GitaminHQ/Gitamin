...
Feature requests and bug reports should be made by using the [issue tracker](https://github.com/gitaminhq/Gitamin/issues). Support questions should be directed to our support email; [support@gitamin.com](mailto:support@gitamin.com?subject=Gitamin Support).
