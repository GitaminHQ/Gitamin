    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="header-with-avatar clearfix">
                <img alt="No group avatar" class="avatar group-avatar s90" src="{{ $user->avatar }}">
                <h3>
                {{ $user->name }}
                </h3>
                <div class="username">
        ...
        <div class="row">
            ...
            <a class="event-filter-link btn btn-default" href="{{ $user->url }}" id="push_event_filter" title="Filter by push events"><span> Push events</span></a>
            <a class="event-filter-link btn btn-default" href="{{ $user->url }}" id="merged_event_filter" title="Filter by merge events"><span> Merge events</span></a>
            </div>
            ...
            <a class="btn btn-green" href="{{ route('projects.new', ['owner'=>$user->username]) }}"><i class="fa fa-plus"></i>
            New Project
            </a></span>
            </div>
            </div>
