        ...
        <div class="row">
            ...
            <aside class='col-md-3'>
                <div class='issuable-sidebar issuable-affix'>
                    <form class="issuable-context-form inline-update js-issuable-update" id="edit_issue_120834" action="{{ $issue->url }}" accept-charset="UTF-8" data-remote="true" method="post">
                    <input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="patch" /><div class='block assignee'>
                    <div class='title'>
                    <label>
                    Assignee
                    </label>
                    ...
                    <div class='block'>
                        ...
                        <div class='selectbox'>
                        <input name="issue[label_ids][]" type="hidden" value="" /><select multiple="multiple" class="select2 js-select2" data-placeholder="Select labels" name="issue[label_ids][]" id="issue_label_ids"><option value="139059">bug</option>
                        <option value="139060">help</option></select>
                        </div>
                    </div>
