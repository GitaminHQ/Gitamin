<div class="nav-header">
	...
	<div class="hide turbolink-spinner"><i class='fa fa-refresh fa-spin'></i> Loading...</div>
		...
		<div class="profile">
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" id="profile-dropdown" data-toggle="dropdown" aria-expanded="true">
                    <span class="avatar hide"><img src="{{ $current_user->gravatar }}"></span> <span class="username">{{ $current_user->username }}</span>
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="profile-dropdown">
                    ...
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="{{ url('/auth/logout') }}"><i class="fa fa-sign-out"></i> {{ trans('dashboard.logout') }}</a>
                    </li>
                </ul>
            </div>
    	</div>
