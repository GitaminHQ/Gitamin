...
<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2">
    ...
    <form class="form-horizontal" name="InstallForm" method="POST" id="install-form" role="form">
        <div class="step block-1">
            <fieldset>
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.cache_driver') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.session_driver') }}</label>
                    <div class="col-sm-6">
        ...
        <div class="step block-2 hidden">
            <fieldset>
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.site_name') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.site_domain') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.git_client_path') }}</label>
                    <div class="col-sm-6">
                 ...
                 <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.git_repositories_path') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.site_timezone') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">{{ trans('forms.install.site_locale') }}</label>
                    <div class="col-sm-6">
